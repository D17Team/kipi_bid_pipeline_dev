create or replace TABLE ALLCITYNETWORK_DEV.ON3_KIPI.STG_BID_RESPONSE_TEST_METRIC cluster by (collector_tstamp)(
	...
	ADUNITCODE VARCHAR(16777216),
	AD_UNIT_PATH VARCHAR(16777216),
	AUCTION_ID VARCHAR(16777216),
	ADVERTISERDOMAINS VARCHAR(16777216),
	AUCTIONSTATUS VARCHAR(16777216),
	BID_SOURCE VARCHAR(16777216),
	BIDDER VARCHAR(16777216),
	BIDDERREQUESTID VARCHAR(16777216),
	CPM FLOAT,
	CURRENCY VARCHAR(16777216),
	ELEMENTID VARCHAR(16777216),
	GLOBALKEY VARCHAR(16777216),
	OOP BOOLEAN,
	ORIGINALCPM VARCHAR(16777216),
	STATUS_MESSAGE VARCHAR(16777216),
	TIME_TO_RESPOND NUMBER(38,0),
	TTL NUMBER(38,0),
	USERIDS VARCHAR(16777216),
	NO_BID_COUNT NUMBER(1,0),
	BID_RESPONSE NUMBER(1,0),
	CANCELLED_BIDS_COUNT NUMBER(1,0),
	TIMED_OUT_BIDS_COUNT NUMBER(1,0)
);